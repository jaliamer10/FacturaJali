...
import com.jalinet.facturaj.control.util.PaginationHelper;
import com.jalinet.facturaj.modelo.Detallefactura;
import static com.jalinet.facturaj.modelo.Detallefactura_.dFCantidad;
import static com.jalinet.facturaj.modelo.Detallefactura_.pRODUCTOSPRProductoID;
...
public class FacturaController implements Serializable {
     ...
     //Valor por defecto a la factura en la hora
    
    private Factura current;
    private DataModel items = null;
    @EJB
    private com.jalinet.facturaj.control.FacturaFacade ejbFacade;
    ...
    public Long getFacturaMax() {
        return ejbFacade.findMax();
    }

    public SelectItem[] getItemsBill(int mes) {
        return JsfUtil.getSelectItems(ejbFacade.findBill(mes), true);
    }
    ...
    public static class FacturaControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Factura) {
                ...
                return getStringKey(o.getFAFacturaID());
            } else {
